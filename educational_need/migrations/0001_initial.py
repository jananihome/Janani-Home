    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('college_school_contact_details', models.CharField(blank=True, max_length=200, null=True)),
                ...
                ('amount_required', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='INR', max_digits=10)),
