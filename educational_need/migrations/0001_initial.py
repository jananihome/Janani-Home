    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional_mobile_number', models.CharField(blank=True, max_length=20, null=True, validators=[django.core.validators.RegexValidator(message='Please use only numeric characters.', regex='^[0-9]*$')])),
                ('hide_mobile_number', models.BooleanField(default=False)),
                ('additional_phone_number', models.CharField(blank=True, max_length=20, null=True, validators=[django.core.validators.RegexValidator(message='Please use only numeric characters.', regex='^[0-9]*$')])),
